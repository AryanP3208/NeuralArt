...
encoder = VGGEncoder(os.path.join('NST_Code', 'vgg_normalised.pth')).to(device)
decoder = Decoder().to(device)
decoder.load_state_dict(torch.load(os.path.join('NST_Code', 'experiment', 'final_exp', 'decoder_final.pth'), map_location=device))
